...
// Функция преобразует строку str в нижний регистр.
...
void *s21_to_lower(const char *str) {
  ...
  // Копируем символы из str в res, переводя буквы в нижний регистр
  while (*str != '\0') {
    if (*str >= 65 &&
        *str <= 90)  // Если символ - заглавная латинская буква ('A'..'Z')
      *res =
          *str + 32;  // Преобразуем в строчную (разница между 'A' и 'a' = 32)
    else
